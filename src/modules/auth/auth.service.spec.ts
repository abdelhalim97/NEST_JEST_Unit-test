...
describe('AuthService', () => {
  ...
  beforeEach(async () => {
    const users = db.collection(User.name);
    const forgotPasswords = db.collection(ForgotPassword.name);
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        { provide: getModelToken(ForgotPassword.name), useValue: forgotPasswords },
        EnvironmentService,
        CommonService,
        JwtService,
